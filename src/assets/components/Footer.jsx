    ...
    return (
        <div className='flex flex-col md:flex-row justify-between items-start'>
            <div className='mb-[40px] md:mb-0'>
                <p className="AGN3D-Font underline text-[28px] md:text-[32px] mb-[10px]">Page</p>
                <nav>
                    <ul className="flex flex-col VSR-Font text-[24px] md:text-[34px] uppercase">
                        <li>
            ...
            <div className='mb-[40px] md:mb-0'>
                <p className="AGN3D-Font underline text-[28px] md:text-[32px] mb-[10px]">Support</p>
                <nav>
                    <ul className="flex flex-col VSR-Font text-[24px] md:text-[34px] uppercase">
                        <li>
            ...
            <div>
                <img src={Logo} alt="Logo" className='h-[120px] md:h-[200px]' />
            </div>
        </div>
    )
}